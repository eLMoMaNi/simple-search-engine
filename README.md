...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| Term Frequency (tf)     | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;1&plus;log_{10}(tf_{t,d})">                                                            | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;1&plus;log_{10}(tf_{t,d})"> |
| Document Frequency (df) | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;log_{10}(\frac{N}{df_{t}})">                                                           | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;1">                                                                             |
| Normalization           | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;\frac{1}{\sqrt{w_{1}^{2}&plus;w_{2}^{2}&plus;w_{3}^{2}&plus;w_{M}^{2}}}"> | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space;\frac{1}{\sqrt{w_{1}^{2}&plus;w_{2}^{2}&plus;w_{3}^{2}&plus;w_{M}^{2}}}">                                                                             |
