...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| Term Frequency (tf)     | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;1&plus;log_{10}(tf_{t,d})">                                                            | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;1&plus;log_{10}(tf_{t,d})"> |
| Document Frequency (df) | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;log_{10}(\frac{N}{df_{t}})">                                                           | <img src="https://latex.codecogs.com/png.latex?\bg_white&space;\large&space; 1 ">                                                                             |
